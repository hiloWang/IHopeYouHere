...
public class MaterialAccount {
    ...
    private com.hilo.navigation.MaterialSection sectionView;
    ...
    public View getSectionView(Context ctx, Typeface font, MaterialSectionListener listener, boolean rippleSupport,int position) {
        if(sectionView == null) {
            sectionView = new com.hilo.navigation.MaterialSection(ctx, com.hilo.navigation.MaterialSection.ICON_40DP,rippleSupport, MaterialSection.TARGET_LISTENER);
