...
public class ActivityDialog extends AppCompatActivity implements
    ...
    public void showThemed() {
        new MaterialDialog.Builder(this)
                ...
                .btnSelector(R.drawable.dialog_btn_selector_custom, DialogAction.POSITIVE)
    ...
    public void showFolderChooser() {
        if (ActivityCompat.checkSelfPermission(ActivityDialog.this, Manifest.permission.READ_EXTERNAL_STORAGE) !=
                PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(ActivityDialog.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, STORAGE_PERMISSION_RC);
            return;
        }
        new FolderChooserDialog.Builder(ActivityDialog.this)
